...
func (s *OpenAIGatewayService) Forward(ctx context.Context, c *gin.Context, account *Account, body []byte) (*OpenAIForwardResult, error) {
	...
	patchedBody, forcedTemplateApplied, err := applyForcedCodexInstructionsTemplateToBodyIfNeeded(c, body, forcedTemplateText, forcedCodexInstructionsTemplateData{
