...
func TestOpenAIGatewayService_SelectAccountWithScheduler_SessionStickyRateLimitedAccountFallsBackToFreshCandidate(t *testing.T) {
	...
	selection, decision, err := svc.SelectAccountWithScheduler(ctx, &groupID, "", "session_hash_rate_limited", "gpt-5.1", nil, OpenAIUpstreamTransportAny, OpenAIUpstreamCapabilityAny, false)
	require.NoError(t, err)
	require.NotNil(t, selection)
	require.NotNil(t, selection.Account)
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_FiltersByOpenAIRequestCapability(t *testing.T) {
	ctx := context.Background()
	groupID := int64(10105)
	...
	selection, _, err := svc.SelectAccountWithScheduler(ctx, &groupID, "", "session_hash_capability_chat", "gpt-5.1", nil, OpenAIUpstreamTransportAny, OpenAIUpstreamCapabilityChatCompletions, false)
	require.NoError(t, err)
	require.NotNil(t, selection)
	require.NotNil(t, selection.Account)
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_FiltersByChatCompletionsCompatibility(t *testing.T) {
	...
	selection, _, err := svc.SelectAccountWithScheduler(ctx, &groupID, "", "session_hash_capability_chat_compatible", "gpt-5.1", nil, OpenAIUpstreamTransportAny, OpenAIUpstreamCapabilityResponsesCompatibleChatCompletions, false)
	require.NoError(t, err)
	require.NotNil(t, selection)
	require.NotNil(t, selection.Account)
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_FiltersByMessagesCompatibility(t *testing.T) {
	...
	selection, _, err := svc.SelectAccountWithScheduler(ctx, &groupID, "", "session_hash_capability_messages_compatible", "gpt-5.1", nil, OpenAIUpstreamTransportAny, OpenAIUpstreamCapabilityResponsesCompatibleMessages, false)
	require.NoError(t, err)
	require.NotNil(t, selection)
	require.NotNil(t, selection.Account)
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_ReturnsModelSupportErrorWhenNoAccountSupportsRequestedModel(t *testing.T) {
	...
	selection, _, err := svc.SelectAccountWithScheduler(ctx, &groupID, "", "session_hash_no_model_support", "GLM-5.1", nil, OpenAIUpstreamTransportAny, OpenAIUpstreamCapabilityResponsesCompatibleChatCompletions, false)
	require.Error(t, err)
	require.Nil(t, selection)
}
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_SessionStickyDBRuntimeRecheckSkipsStaleCachedAccount(t *testing.T) {
	...
	selection, decision, err := svc.SelectAccountWithScheduler(ctx, &groupID, "", "session_hash_db_runtime_recheck", "gpt-5.1", nil, OpenAIUpstreamTransportAny, OpenAIUpstreamCapabilityAny, false)
	require.NoError(t, err)
	require.NotNil(t, selection)
	require.NotNil(t, selection.Account)
...
func TestOpenAIGatewayService_OpenAIAccountSchedulerMetrics(t *testing.T) {
	...
	selection, _, err := svc.SelectAccountWithScheduler(ctx, &groupID, "", "session_hash_metrics", "gpt-5.1", nil, OpenAIUpstreamTransportAny, OpenAIUpstreamCapabilityAny, false)
	require.NoError(t, err)
	require.NotNil(t, selection)
