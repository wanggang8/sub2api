...
func TestFetchUpstreamSupportedModelsAppliesSkipTLSVerifyOption(t *testing.T) {
	t.Parallel()
	...
	opts := UpstreamRequestOptionsFromContext(upstream.lastReq.Context())
	require.True(t, opts.SkipTLSVerify)
}
