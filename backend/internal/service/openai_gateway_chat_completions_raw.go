...
func (s *OpenAIGatewayService) forwardAsRawChatCompletions(
	...
	patchedBody, _, err := applyForcedCodexInstructionsTemplateToChatCompletionsBodyIfNeeded(c, upstreamBody, forcedTemplateText, forcedCodexInstructionsTemplateData{
