...
func TestBuildUpstreamTransportSetsDialTimeout(t *testing.T) {
	...
	transport, err := buildUpstreamTransport(settings, nil, upstreamProtocolModeDefault, false)
...
func TestBuildUpstreamTransportAppliesSkipTLSVerify(t *testing.T) {
	transport, err := buildUpstreamTransport(defaultPoolSettings(nil), nil, upstreamProtocolModeDefault, true)
	require.NoError(t, err)
...
func TestBuildUpstreamTransportKeepsDialTimeoutWithHTTPProxy(t *testing.T) {
	...
	transport, err := buildUpstreamTransport(defaultPoolSettings(nil), proxyURL, upstreamProtocolModeDefault, false)
	require.NoError(t, err)
