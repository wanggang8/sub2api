...
func newCompatRoutesTestRouter() *gin.Engine {
	...
	handlers := &handler.Handlers{
		...
		CursorCompat:  &handler.CursorCompatHandler{},
		AugmentCompat: &handler.AugmentCompatHandler{},
	}
	apiKeyAuth := servermiddleware.APIKeyAuthMiddleware(func(c *gin.Context) {
		c.Next()
	})

	RegisterCursorCompatRoutes(router, handlers, apiKeyAuth, nil, nil, nil, nil, &config.Config{})
	RegisterAugmentCompatRoutes(router, handlers, apiKeyAuth, nil, nil, nil, nil, &config.Config{})
	return router
}
...
func TestCompatRoutesUseProtocolErrorSchemaOnAuthFailure(t *testing.T) {
	...
	RegisterCursorCompatRoutes(router, handlers, apiKeyAuth, apiKeyService, nil, nil, nil, cfg)
	RegisterAugmentCompatRoutes(router, handlers, apiKeyAuth, apiKeyService, nil, nil, nil, cfg)
	...
	t.Run("augment", func(t *testing.T) {
		rec := httptest.NewRecorder()
...
func TestCompatRoutesRejectUngroupedKeyWithProtocolSchema(t *testing.T) {
	...
	RegisterCursorCompatRoutes(router, handlers, apiKeyAuth, apiKeyService, nil, nil, settingService, cfg)
	RegisterAugmentCompatRoutes(router, handlers, apiKeyAuth, apiKeyService, nil, nil, settingService, cfg)
...
func TestCompatRoutesSkipBillingForAugmentUsagePaths(t *testing.T) {
	...
	t.Run("get_models_allows_expired_key", func(t *testing.T) {
		rec := httptest.NewRecorder()
	...
	t.Run("balance_allows_expired_key", func(t *testing.T) {
		rec := httptest.NewRecorder()
	...
	t.Run("login_token_allows_expired_key", func(t *testing.T) {
		rec := httptest.NewRecorder()
...
func (r *compatRouteAPIKeyRepoStub) Create(ctx context.Context, key *service.APIKey) error { return errors.New("not implemented") }
...
func (r *compatRouteAPIKeyRepoStub) Update(ctx context.Context, key *service.APIKey) error { return errors.New("not implemented") }
func (r *compatRouteAPIKeyRepoStub) Delete(ctx context.Context, id int64) error { return errors.New("not implemented") }
...
func (r *compatRouteSettingRepoStub) Set(ctx context.Context, key, value string) error { return errors.New("not implemented") }
...
func (r *compatRouteSettingRepoStub) Delete(ctx context.Context, key string) error { return errors.New("not implemented") }
