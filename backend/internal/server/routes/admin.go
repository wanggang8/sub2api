...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/models/fetch", h.Admin.Account.FetchModelsFromUpstream)
		accounts.POST("/fetch-models-preview", h.Admin.Account.FetchModelsPreview)
...
func registerUsageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	usage := admin.Group("/usage")
	{
		...
		usage.GET("/debug/:request_id", h.Admin.Usage.GetDebugDetail)
		usage.GET("/debug/:request_id/export", h.Admin.Usage.ExportDebugDetail)
