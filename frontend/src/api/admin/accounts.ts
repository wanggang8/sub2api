...
export interface ModelsPreviewResult {
  models: ClaudeModel[]
...
): Promise<ModelsPreviewResult> {
  const { data } = await apiClient.post<ModelsPreviewResult>('/admin/accounts/fetch-models-preview', {
