export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      modelsLoaded: 'Loaded {count} model(s) from upstream',
      modelsLoadedFromDefault: 'Using default models ({count} models)',
      modelsLoadFailed: 'Failed to fetch models',
    ...
    usage: {
      ...
      debugDetailEmpty: 'Debug detail not found or expired',
      debugDetailLoadFailed: 'Failed to load debug detail',
      debugDetailExportFailed: 'Failed to export debug detail',
      exportDebugDetail: 'Export Debug Detail',
      ...
      debugBodyTruncated: 'Content truncated for preview. Original size: {bytes} bytes',
      cleanup: {
        button: 'Cleanup',
