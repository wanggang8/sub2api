export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for 牛马蓄水池 end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for 牛马蓄水池 end-user login',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by upstream 牛马蓄水池 sites. Account rates change only when the separate sync switch is enabled.',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on 牛马蓄水池 orders; the upstream type is sent as EasyPay type.',
