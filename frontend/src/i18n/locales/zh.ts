  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        upstreamCapabilities: '上游接口能力',
        upstreamCapabilitiesDesc: '声明该 OpenAI 账号的上游实际支持哪些接口，调度会按入口选择兼容的上游协议。',
        upstreamPresetStandard: '标准 OpenAI',
        upstreamPresetChatOnly: '仅 Chat',
        upstreamPresetChatMessages: 'Chat + Messages',
        supportsResponsesApi: '支持 Responses API',
        supportsChatCompletionsApi: '支持 Chat Completions API',
        supportsMessagesApi: '支持 Messages API',
        upstreamCapabilityRequired: '至少启用一个 OpenAI 上游接口能力。',
      ...
      fetchingModels: '拉取中...',
      refreshModels: '刷新模型',
      modelsLoaded: '已从上游加载 {count} 个模型',
      modelsLoadedFromDefault: '使用默认模型列表（{count} 个）',
      modelsLoadFailed: '拉取模型失败',
    ...
    usage: {
      ...
      debugDetail: '调试详情',
      debugDetailEmpty: '调试详情不存在或已过期',
      debugDetailLoadFailed: '加载调试详情失败',
      debugDetailExportFailed: '导出调试详情失败',
      exportDebugDetail: '导出调试详情',
      requestHeaders: '请求头',
      responseHeaders: '响应头',
      requestBody: '请求体',
      responseBody: '响应体',
      ...
      debugBodyTruncated: '内容已为预览截断，原始大小：{bytes} 字节',
      cleanup: {
        button: '清理',
        title: '清理使用记录',
