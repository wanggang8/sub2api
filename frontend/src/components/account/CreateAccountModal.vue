...
const syncPreviewCredentials = computed(() => {
  ...
  return {
    ...
    skip_tls_verify: apiKeySkipTLSVerify.value,
...
const hasCustomAPIKeyBaseURL = computed(() => (
  ['openai', 'anthropic', 'gemini', 'grok'].includes(form.platform)
  && accountCategory.value === 'apikey'
  && isCustomPlatformBaseURL(form.platform, apiKeyBaseUrl.value || getDefaultAPIKeyBaseURL(form.platform))
))
