...
const messages: Record<string, string> = {
  ...
  'admin.usage.debugDetail': 'Debug Detail',
}
...
describe('admin UsageTable tooltip', () => {
  ...
  it('emits debugClick when the debug detail button is pressed', async () => {
    const row = {
    ...
    expect(wrapper.emitted('debugClick')?.[0]).toEqual(['req-debug-1'])
  })
})
